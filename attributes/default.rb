...
default['java']['PATH'] = ':/usr/local/bin:/usr/bin:/usr/local/sbin:/usr/sbin:/usr/local/lib:/opt/chefdk/bin:/opt/chefdk/embedded/bin:/opt/neo-store-maven/current/bin:/home/{yahoo_id}/.local/bin:/home/{yahoo_id}/bin'
